...
final class ConfigReflectionExtension implements PropertiesClassReflectionExtension
{
    ...
    public function __construct()
    {
        $this->properties = [
            ...
            'parallel' => new IntegerType(),
            'cache' => new BooleanType(),
            'cacheFile' => TypeCombinator::addNull(new StringType()),
            ...
            'ignored' => new ArrayType(new StringType(), new StringType()),
            'reportFile' => TypeCombinator::addNull(new StringType()),
            'generator' => TypeCombinator::addNull(new StringType()),
            'filter' => TypeCombinator::addNull(new StringType()),
            'bootstrap' => new ArrayType(new IntegerType(), new StringType()),
            'reportWidth' => TypeCombinator::addNull(TypeCombinator::union(new IntegerType(), new StringType())),
            'errorSeverity' => new IntegerType(),
            'warningSeverity' => new IntegerType(),
            'recordErrors' => new BooleanType(),
            'suffix' => new StringType(),
            'basepath' => TypeCombinator::addNull(new StringType()),
            'stdin' => new BooleanType(),
            'stdinContent' => TypeCombinator::addNull(new StringType()),
            'stdinPath' => TypeCombinator::addNull(new StringType()),
